...
public class TicketServlet extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		try{
			...
			TicketFileWriter.writeFile(tic, "E:\\fuzzy-doodle\\ParkingSystemWeb2\\src\\ticket.csv");
			...
			TicketHistoryFileWriter.writeFile(tic, "E:\\fuzzy-doodle\\ParkingSystemWeb2\\src\\tickethistory.csv");
